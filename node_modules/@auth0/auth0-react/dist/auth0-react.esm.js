...
var Auth0Provider = function (opts) {
    ...
    var client = useState(function () { return providedClient !== null && providedClient !== void 0 ? providedClient : new Lu(toAuth0ClientOptions(clientOpts)); })[0];
    ...
    var anonymous = useMemo(function () { return client.anonymous; }, [client]);
...
export { Lc as AnonymousSessionError, Auth0Context, Auth0Provider, R as AuthenticationError, x as ConnectError, C as GenericError, He as InMemoryCache, A as InvalidConfigurationError, Ze as LocalStorageCache, bu as MfaChallengeError, vu as MfaEnrollmentError, ku as MfaEnrollmentFactorsError, wu as MfaError, gu as MfaListAuthenticatorsError, N as MfaRequiredError, _u as MfaVerifyError, K as MissingRefreshTokenError, M as MissingScopesError, Rt as MyAccountApiError, OAuthError, fc as PasskeyChallengeError, Pu as PasskeyError, mc as PasskeyGetTokenError, pc as PasskeyRegisterError, j as PopupCancelledError, W as PopupOpenError, O as PopupTimeoutError, ct as RefreshTokenMode, ut as ResponseType, I as TimeoutError, U as UseDpopNonceError, lt as User, initialContext, useAuth0, useAuth0Suspense, useEnterpriseConnect, withAuth0, withAuthenticationRequired };
